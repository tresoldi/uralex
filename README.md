...
- **Synonymy:** 1.16
- **With UPA transcription:** 3,885 (13 languages)
- **With IPA transcription:** 5,257 (17 languages)
- **With segments:** 4,955
- **Borrowings:** 2,184

Statistics can be regenerated with `python3 stats.py raw/`.
