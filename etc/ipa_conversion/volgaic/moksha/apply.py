"""Apply Moksha IPA conversion to all UraLex items and validate."""
...
def main():
    # Load UraLex data for moksha
    with open(os.path.join(URALEX, "raw", "Data.tsv")) as f:
        reader = csv.DictReader(f, delimiter="\t")
        all_rows = list(reader)

    rows = [r for r in all_rows if r["uralex_lang"].lower() == "moksha"
