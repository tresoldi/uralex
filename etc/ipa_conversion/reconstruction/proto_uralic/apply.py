"""Apply Proto-Uralic IPA conversion to all UraLex items and validate."""
...
def main():
    ...
    rows = [r for r in all_rows if r["uralex_lang"].lower() == "proto_uralic"
    ...
    # Report
    print(f"=== Proto-Uralic IPA conversion ===")
