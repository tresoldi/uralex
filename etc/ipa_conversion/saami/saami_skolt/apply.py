"""Apply Skolt Saami IPA conversion to all UraLex items and validate."""
...
def main():
    # Load UraLex data for saami_skolt
    with open(os.path.join(URALEX, "raw", "Data.tsv")) as f:
        reader = csv.DictReader(f, delimiter="\t")
        all_rows = list(reader)

    rows = [r for r in all_rows if r["uralex_lang"].lower() == "saami_skolt"
    ...
    # Report
    print(f"=== Skolt Saami IPA conversion ===")
