"""Apply Pite Saami IPA conversion to all UraLex items and validate."""
...
def main():
    ...
    rows = [r for r in all_rows if r["uralex_lang"].lower() == "saami_pite"
    ...
    # Report
    print(f"=== Pite Saami IPA conversion ===")
